...
*/
    ...
    {RIL_UNSOL_PCMCLOCK_STATE, NULL, WAKE_PARTIAL}, // 11022
    {RIL_UNSOL_1X_SMSPP, NULL, WAKE_PARTIAL}, // 11023
    ...
    {RIL_UNSOL_STK_ALPHA_ID, NULL, WAKE_PARTIAL}, // 11035
    {RIL_UNSOL_PB_INIT_COMPLETE, NULL, WAKE_PARTIAL}, // 11036
    {11037, NULL, WAKE_PARTIAL}, // 11037
    {11038, NULL, WAKE_PARTIAL}, // 11038
    {11039, NULL, WAKE_PARTIAL}, // 11039
    {11040, NULL, WAKE_PARTIAL}, // 11040
    {RIL_UNSOL_RTS_INDICATION, NULL, WAKE_PARTIAL}, // 11041
    {RIL_UNSOL_RILD_RESET_NOTI, NULL, WAKE_PARTIAL}, // 11042
    {RIL_UNSOL_HOME_NETWORK_NOTI, NULL, WAKE_PARTIAL}, // 11043
    {11044, NULL, WAKE_PARTIAL}, // 11044
    {RIL_UNSOL_OMADM_SEND_DATA, NULL, WAKE_PARTIAL}, // 11045
    {RIL_UNSOL_DUN, NULL, WAKE_PARTIAL}, // 11046
    {RIL_UNSOL_SYSTEM_REBOOT, NULL, WAKE_PARTIAL}, // 11047
    {11048, NULL, WAKE_PARTIAL}, // 11048
    {RIL_UNSOL_UTS_GETSMSCOUNT, NULL, WAKE_PARTIAL}, // 11049
    {RIL_UNSOL_UTS_GETSMSMSG, NULL, WAKE_PARTIAL}, // 11050
    {RIL_UNSOL_UTS_GET_UNREAD_SMS_STATUS, NULL, WAKE_PARTIAL}, // 11051
    {RIL_UNSOL_MIP_CONNECT_STATUS, NULL, WAKE_PARTIAL}, // 11052
    {RIL_UNSOL_STK_CALL_STATUS, NULL, WAKE_PARTIAL}, // 11053
